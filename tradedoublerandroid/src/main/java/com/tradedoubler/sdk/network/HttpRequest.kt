...
import com.tradedoubler.sdk.utils.Constant.CONVTAGTID
import com.tradedoubler.sdk.utils.Constant.CONVTAGTID_VALUE
...
object HttpRequest {
    ...
    fun trackingInstallation(
        ...
        urlBuilder.addQueryParameter(CONVTAGTID, CONVTAGTID_VALUE)
